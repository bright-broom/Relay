...
const {tokens,breakpoints}=await import('data:text/javascript;base64,'+Buffer.from(tokenModule.outputFiles[0].text).toString('base64'));
...
await build({entryPoints:['src/prototype/app.ts'],outfile:'prototype/assets/app.js',bundle:true,format:'iife',target:'es2022',minify:true});
console.log('Built Relay design preview.');
