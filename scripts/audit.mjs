...
const files=(await readdir('src',{recursive:true})).filter(path=>path.endsWith('.ts')&&!path.startsWith('i18n/locales/')&&!['i18n/messages.ts','design/tokens.ts'].includes(path));
