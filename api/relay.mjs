...
var en = {
  ...
  publicPreviewHint: "Sample data (changes saved in this tab)",
  ...
  importNote: "Files are not sent. The results shown are samples.",
...
var componentTokens = {
  "type-page": primitives["text-lg"],
  "type-page-mobile": primitives["title-mobile"],
  "type-section": primitives["text-md"],
  ...
  "rail-padding": "calc((var(--sidebar) - var(--touch) - var(--border-width)) / 2)",
  "tooltip-max": "14rem",
